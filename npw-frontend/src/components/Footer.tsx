...
const Footer: React.FC<{ navigateTo: (path: string) => void; }> = ({ navigateTo }) => {
    ...
    const [socialLinks, setSocialLinks] = useState<{ facebook: string; twitter: string; instagram: string }>({
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                const links = res?.settings?.socialLinks;
                if (!cancelled && links) {
                    setSocialLinks({
                        facebook: String(links.facebook || 'https://facebook.com'),
                        twitter: String(links.twitter || 'https://twitter.com'),
                        instagram: String(links.instagram || 'https://instagram.com'),
                    });
                }
            } catch {
