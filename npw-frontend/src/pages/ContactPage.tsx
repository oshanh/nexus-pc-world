...
const InfoItem: React.FC<{ icon: React.ReactNode; title: string; children: React.ReactNode }> = ({ icon, title, children }) => (
    <div className="flex items-start gap-4">
        <div className="text-nexus-blue flex-shrink-0 w-8 h-8 mt-1">{icon}</div>
        <div>
    ...
    return (
        <div className="border-b border-nexus-blue/20 last:border-b-0">
            ...
            >
                ...
                <svg className={`w-6 h-6 text-nexus-blue transform transition-transform duration-300 flex-shrink-0 ${isOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="text-nexus-light bg-nexus-dark p-8 rounded-lg space-y-8">
                         ...
                         <InfoItem 
                            ...
                            title="Address"
                         >
                            <p>123 Cyber Street, Neon City, 90210</p>
                         </InfoItem>
                         ...
                         <InfoItem 
                            ...
                            title="Email"
                         >
                            <a href="mailto:contact@nexusgaming.com" className="hover:text-nexus-blue transition-colors">contact@nexusgaming.com</a>
                         </InfoItem>
                         ...
                         <div className="pt-4 border-t border-nexus-gray">
                            <div className="block rounded-lg overflow-hidden group">
                                <img src="https://picsum.photos/seed/map/600/400" alt="Map to Nexus Gaming" className="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-300" />
                            </div>
                         </div>
                    </div>
                </div>
